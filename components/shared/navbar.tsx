...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center py-3 bg-white dark:bg-background shadow-sm">
      <div className="w-full max-w-6xl flex items-center justify-between px-4">
        <Link href={"/"} className="flex items-center space-x-2">
          <Building2 className="h-8 w-8 text-primary" />
          <h1 className="text-xl font-bold text-primary">BookingR</h1>
        </Link>
          ...
          {status === "authenticated" ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                {session.currentUser.role === ROLE.ADMIN && (
